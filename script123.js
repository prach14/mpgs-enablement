    ...
    if (selectedValue) {
        switch (selectedValue) {
            ...
            case "Payment facilator/Agregator":
                ...
                displayContent = [
                   { text: "MSO Level Changes", highlight: true },
					 { text: " To to Privlege tab aand Enable the “Aggregator”  previlege", highlight: false,imageSrc:'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/mso agggr.JPG' },
					{ text: "Acuire Link Level Changes", highlight: true },
					{ text: "Enable “Aggregatorsupport” ", highlight: false,imageSrc:'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/aggr.JPG' },
                    { text: "Toggles enablment on MSO level", highlight: true },
					{ text: "N/A",highlight:false},
					{text:"RSC and LCS level changes", highlight: true },
            ...
            case "TAP ON PHONE":
                ...
                displayContent = [
					...
					{ text: "In Previleged tab Enable “EMV” parameter for MSO ", highlight: false,imageSrc:'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/emv.JPG' },
					{ text: "Acuire Link Level Changes", highlight: true },
					{ text: "In General tab Enable “OnlinePIN” parameter ", highlight: false,imageSrc:'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/pin.JPG' },
                    { text: "Toggles enablment on MSO level", highlight: true },
