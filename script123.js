    ...
    if (selectedValue) {
        switch (selectedValue) {
            ...
            case "Payment facilator/Agregator":
                displayContent = [
                    { text: "MSO Level Changes", highlight: true },
                    { text: "Enable the Aggregator", highlight: false, imageSrc: 'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/mso agggr.JPG' },
            ...
            case "TAP ON PHONE":
                displayContent = [
                    ...
                    { text: "EMV", highlight: false, imageSrc: 'https://raw.githubusercontent.com/prach14/mpgs-enablement/main/EMVM.JPG' },
                    { text: "Acuire Link Level Changes", highlight: true },
                    ...
                    { text: "In General tab Enable “EMV” parameter for acuire link ", highlight: false },
